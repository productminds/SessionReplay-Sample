...
"[project]/node_modules/@amplitude/rrweb-record/dist/rrweb-record.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function serializeNode(n2, options) {
    const { doc, mirror: mirror2, blockClass, blockSelector, needsMask, inlineStylesheet, maskInputOptions = {}, maskTextFn, maskInputFn, dataURLOptions = {}, inlineImages, recordCanvas, keepIframeSrcFn, newlyAddedElement = false, cssCaptured = false, applyBackgroundColorToBlockedElements = false } = options;
...
function serializeElementNode(n2, options) {
    const { doc, blockClass, blockSelector, inlineStylesheet, maskInputOptions = {}, maskInputFn, dataURLOptions = {}, inlineImages, recordCanvas, keepIframeSrcFn, newlyAddedElement = false, rootId, applyBackgroundColorToBlockedElements = false } = options;
...
function serializeNodeWithId(n2, options) {
    const { doc, mirror: mirror2, blockClass, blockSelector, maskTextClass, maskTextSelector, skipChild = false, inlineStylesheet = true, maskInputOptions = {}, maskTextFn, maskInputFn, slimDOMOptions, dataURLOptions = {}, inlineImages = false, recordCanvas = false, onSerialize, onIframeLoad, iframeLoadTimeout = 5e3, onStylesheetLoad, stylesheetLoadTimeout = 5e3, keepIframeSrcFn = ()=>false, newlyAddedElement = false, cssCaptured = false, applyBackgroundColorToBlockedElements = false } = options;
...
function initCanvasWebGLMutationObserver(cb, win, blockClass, blockSelector) {
    ...
    if (typeof win.WebGL2RenderingContext !== "undefined") {
        handlers.push(...patchGLPrototype(win.WebGL2RenderingContext.prototype, CanvasContext.WebGL2, cb, blockClass, blockSelector, win));
    }
    return ()=>{
        handlers.forEach((h)=>h());
    };
...
//# sourceMappingURL=node_modules_%40amplitude_rrweb-record_dist_rrweb-record_ebd792e0.js.map